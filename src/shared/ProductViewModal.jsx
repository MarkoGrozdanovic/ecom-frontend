      ...
      <Dialog open={open} as="div" className="relative z-10" onClose={close}>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel
              transition
              className="relative transform overflow-hidden rounded-lg bg-white shadow-xl transition-all md:max-w[620px] md:min-w-155"
            >
              {image && (
              ...
              <div className="px-6 pt-10 pb-2">
                <DialogTitle
                  as="h1"
                  className="lg:text-3xl sm:text-2xl text-xl font-semibold text-gray-800 mb-4"
                >
                  {productName}
                </DialogTitle>
              ...
              <div className="px-4 py-4 flex justify-end gap-4">
                <button
                  type="button"
