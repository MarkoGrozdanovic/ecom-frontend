...
const Contact = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://images.pexels.com/photos/374894/pexels-photo-374894.jpeg?_gl=1*erlz60*_ga*MTMyNTQ3NzIyNi4xNzY4NzAxNDg4*_ga_8JE65Q40S6*czE3Njg3MDE0ODckbzEkZzEkdDE3Njg3MDE3MjEkajM2JGwwJGgw')",
      }}
    >
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-lg">
        ...
        <div className="mt-8 text-center">
          <h2 className="text-lg font font-semibold">Contact Information</h2>
          <div className="flex flex-col items-center space-y-2 mt-4">
            <div className="flex items-center">
              <FaPhone className="text-blue-500 mr-2" />
              <span className="text-gray-600">+381 64 323 98 12</span>
            </div>
